...
## Week 3
collatz.py contains my answer to the exercise for week 3. Details of the collatz conjecture can be fond [here] (https://en.wikipedia.org/wiki/Collatz_conjecture).
...
Also I noticed that integer division resulted in floating point numbers - the printout looked a little strange to me so i rounded all the outputs using the [round function](https://docs.python.org/3/library/functions.html#round) (so there are no decimels).
## Week 5
